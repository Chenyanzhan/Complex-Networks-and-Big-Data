...
def extract_degree_data(index):

    file_name_list = os.listdir('./split/' + index)
    ...
    for name in tqdm(file_name_list):
        ...
        file_path = os.path.join('./split/'+index+'/',name) # 指定txt文件的路径
    ...
    save_path = './split_degree_file/'+index+'citation_degree.txt'
...
if __name__ == '__main__':
    ...
    field = '7'
    num_list = extract_degree_data(field)


    file_path = './split_degree_file/'+field+'citation_degree.txt' # 指定txt文件的路径
